...
def publishData(txt):
    ...
    while (True):
        ...
        client.publish("raspb1/data", payload=json.dumps({"timestamp": timestamp,"SMOKE":GPIO.input(4), "Temperature": temp_c}), qos=0, retain=False)

 

def main():
    desktop_path="/home/nishi/Desktop/"
